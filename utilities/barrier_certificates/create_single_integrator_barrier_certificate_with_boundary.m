...
%       size of the robots.
    ...
    assert(safety_radius > 0, "In the function create_single_integrator_barrier_certificate_with_boundary, the safety distance that two robots cannot get closer to each other than (SafetyRadius) must be greater than the diameter of a single robot (0.15m). Recieved " + num2str(safety_radius) + ".")
